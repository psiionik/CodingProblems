...
def testCase1(f: (Array[Int], Int) => Int): Unit = {
    val nums = Array(8, 2, 4, 7)
    val limit = 4

    val res = f(nums, limit)
    println(res)
...
// def testCase3(f: (Array[Int], Int) => Int): Unit = {
...
// def testCase4(f: (Array[Int], Int) => Int): Unit = {
...
// def testCase5(f: (Array[Int], Int) => Int): Unit = {
//     val nums = Array(-1)
...
@main def mainSol1() = {
    runTestCases(Solution1.longestSubarray)
}
